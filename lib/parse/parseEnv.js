const {map, filter, split, reduce_to_object, replace, removeQuotes} = require('../../support/helpers')
...
const clear_empty_element = filter(el => !!el)
...
const parse_file = compose(parse_object, split_in_lines, clear_empty_element, split_line_break,
